...
namespace App\Http\Controllers\leaseplan;use Illuminate\Http\Request;
...
class FoldersController extends Controller
{
	...
	*/
    ...
    public function index(Request $request)
    {
    	...
    	$folders = DB::select('select f.id_folder,f.nombre,f.texto,d.descripcion,t.nombre_tabla  from sgd_folders f,sgd_estados d,sgd_tablas t 
