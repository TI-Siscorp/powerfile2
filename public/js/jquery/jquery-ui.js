...
function Datepicker() {
	...
	this.regional[""] = { // Default regional settings
		...
		dayNames: ["Domingo", "Lunes", "Martes", "Miercoles", "Jueves", "Viernes", "SÃ¡bado"], // For formatting
		dayNamesShort: ["Dom", "Lun", "Mar", "Mier", "Jue", "Vie", "Sab"], // For formatting
		dayNamesMin: ["Dom","Lu","Ma","Mi","Ju","Vi","Sa"], // Column headings for days starting at Sunday
