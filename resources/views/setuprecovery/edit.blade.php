...
@section('titulo')
 {{ trans('principal.editrecovery') }} 
@endsection

@section('tituloPagina')
<h3>{{ trans('principal.editerror') }} : {{ $reupera->ftp_server }}</h3>
@endsection
...
<div class="panel">
	<div class="panel-body">
		...
		{!! Form::model($reupera, ['method' => 'PATCH','route' => ['setuprecovery.update', $reupera->id_setup],'class'=>'form-horizontal bordered-row']) !!}
		    ...
		    <div class="form-group">
		    	...
		    	<div class="form-group mododebodega">
					...
					<div class="col-sm-6">
						{!! Form::text('ftp_server',$reupera->ftp_server,['class'=>'form-control']) !!} 
					</div>
				</div>
				...
				<div class="form-group mododebodega">
					...
					<div class="col-sm-6">
						{!! Form::text('ftp_user',$reupera->ftp_user,['class'=>'form-control']) !!}
					</div>
				</div>
				...
				<div class="form-group mododebodega">
                   {!! Form::label('ftp_pass',trans('principal.itempassserver'),['class'=>'col-sm-3 control-label']) !!}
                    <div class="col-sm-6">
                       {!! Form::text('ftp_pass',$reupera->ftp_pass,['class'=>'form-control']) !!}
                    </div>
           		</div>	
				...
				<div class="form-group mododebodega">
					...
					<div class="col-sm-6">
						{!! Form::text('ftp_port',$reupera->ftp_port,['class'=>'form-control']) !!} 
					</div>
				</div>
		    ...
		    <div class="form-group">
				...
				<div class="form-group centrartexto" >
					...
					{{ link_to_route('setuprecovery.index', trans('principal.btnca'), '', array('class'=>'btn btn-danger btn-close')) }}
				</div>
...
<script type="text/javascript">		
	...
	var id_estadoreg = '{{ $reupera->id_estado }}'; 

	var estatus = '{{ $reupera->estatus }}'; 

	var modobodega = '{{ $reupera->modobodega }}';   
