...
@section('titulo')
	 {{ trans('principal.nrecovery') }}  
@endsection

@section('tituloPagina')
	<h3>{{ trans('principal.nrecovery') }} </h3>
@endsection
...
<div class="panel">
		<div class="panel-body">
			...
			@endif
				...
				{!! Form::open(['route'=>'setuprecovery.store','method'=>'POST','class'=>'form-horizontal bordered-row']) !!}
					
					
					<div class="form-group">
	                    {!! Form::label('modobodega',trans('principal.msgconfrecovery'),['class'=>'col-sm-3 control-label']) !!}
	                    <div class="col-sm-6">
