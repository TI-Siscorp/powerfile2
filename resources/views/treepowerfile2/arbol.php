<?php
   ...
   for ($i = 0; $i <(count($dirppl) - $posi); $i++)
	   {
	   		$ubicar .= $dirppl[$i].'/';
	   }*/
   
   $host= $_SERVER["HTTP_HOST"];  //echo "http://" . $host;
   ...
   if ($host == 'localhost')
	   {
	   	$ubicar = "http://" . $host . '/'.$dirurl[1].'/'.$dirurl[2].'/';
	   }
	else
		{
			$ubicar = '';
...
<html>
	<head>
		...
		<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
		  ...
		  <script type="text/javascript" charset="utf8" src="<?php echo $ubicar;?>public/js/jquery/jquery-1.8.2.min.js"></script>
	
		   
		  <link rel="stylesheet" href="<?php echo $ubicar;?>public/assets/bootstrap/css/bootstrap.css">
		  
		  <script src="<?php echo $ubicar;?>public/js/bootstrap.min.js"></script>
		  		  
		  <link rel="stylesheet" type="text/css" href="<?php echo $ubicar;?>public/assets/widgets/multi-select/multiselect.css">
		  
		  <script type="text/javascript" src="<?php echo $ubicar;?>public/assets/widgets/multi-select/multiselect.js"></script>
		  <script type="text/javascript" src="<?php echo $ubicar;?>public/js/quicksearch/jquery.quicksearch.js"></script>
		 
		
		<link rel="stylesheet" href="dist/themes/default/style.css" />
		
		<link rel="stylesheet" type="text/css" href="<?php echo $ubicar;?>public/assets/icons/fontawesome/fontawesome.css">
		<link rel="stylesheet" type="text/css" href="<?php echo $ubicar;?>public/assets/icons/linecons/linecons.css">
		<link rel="stylesheet" type="text/css" href="<?php echo $ubicar;?>public/css/estilo_powerfile.css">
...
<script type="text/javascript">
					            ...
					            Tipodoc: {
					                ...
					                action: function (obj) { 
									    ...
									    $(function() { "use strict";
									       ...
									       $(".ms-container").append('<i ><img class="img-circle" width="25" src="../../../public/img/17858-200.png" alt="" style="position:relative;left: 3%;margin-top: 20% !important;"></i>');
									    });
        ...
        $(".ms-container").append('<i ><img class="img-circle" width="25" src="<?php echo $ubicar;?>public/img/17858-200.png" alt="" style="position:relative;left: 3%;margin-top: 20% !important;"></i>');
    });
