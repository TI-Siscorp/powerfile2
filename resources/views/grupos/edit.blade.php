...
@section('titulo')
	{{ trans('principal.editgrp') }}  
@endsection

@section('tituloPagina')
	<h3>{{ trans('principal.editgrp') }} : {{ $grupos->nombre }}</h3>
@endsection
...
<div class="panel">
	<div class="panel-body">
		...
		{!! Form::model($grupos, ['method' => 'PATCH','route' => ['grupos.update', $grupos->id_grupo],'class'=>'form-horizontal bordered-row']) !!}
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					{!! Form::text('nombre',$grupos->nombre,['class'=>'form-control']) !!}
				</div>
			</div>
			
			<div class="form-group">
				{!! Form::label('id_estado',trans('principal.titestamayu'),['class'=>'col-sm-3 control-label']) !!}
				<div class="col-sm-6">
...
<script type="text/javascript">
	...
	var id_estadoreg = {{ $grupos->id_estado }};
