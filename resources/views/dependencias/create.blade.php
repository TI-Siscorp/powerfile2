...
@section('titulo')
	{{ trans('principal.nuevadepe') }}
@endsection

@section('tituloPagina')
	<h3>{{ trans('principal.nuevadepe') }}</h3>
@endsection
...
<div class="panel">
	<div class="panel-body">
		...
		{!! Form::open(['route'=>'dependencias.store','method'=>'POST','class'=>'form-horizontal bordered-row']) !!}
			...
			<div class="form-group">
				{!! Form::label('codigo_departamento',trans('principal.inputcoddep'),['class'=>'col-sm-3 control-label']) !!}
				<div class="col-sm-6">
