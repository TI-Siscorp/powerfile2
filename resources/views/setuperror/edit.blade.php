...
@section('titulo')
 {{ trans('principal.editerror') }} 
@endsection

@section('tituloPagina')
<h3>{{ trans('principal.editerror') }} : {{ $errores->ftp_server }}</h3>
@endsection
...
<div class="panel">
	<div class="panel-body">
		...
		{!! Form::model($errores, ['method' => 'PATCH','route' => ['setuperror.update', $errores->id_setup],'class'=>'form-horizontal bordered-row']) !!}
		    ...
		    <div class="form-group">
		    	...
		    	<div class="form-group mododebodega">
					...
					<div class="col-sm-6">
						{!! Form::text('ftp_server',$errores->ftp_server,['class'=>'form-control']) !!} 
					</div>
				</div>
				...
				<div class="form-group mododebodega">
					...
					<div class="col-sm-6">
						{!! Form::text('ftp_user',$errores->ftp_user,['class'=>'form-control']) !!}
					</div>
				</div>
				...
				<div class="form-group mododebodega">
                   {!! Form::label('ftp_pass',trans('principal.itempassserver'),['class'=>'col-sm-3 control-label']) !!}
                    <div class="col-sm-6">
                       {!! Form::text('ftp_pass',$errores->ftp_pass,['class'=>'form-control']) !!}
                    </div>
           		</div>	
				...
				<div class="form-group mododebodega">
					...
					<div class="col-sm-6">
						{!! Form::text('ftp_port',$errores->ftp_port,['class'=>'form-control']) !!} 
					</div>
				</div>
		    ...
		    <div class="form-group">
				...
				<div class="form-group centrartexto" >
					...
					{{ link_to_route('setuperror.index', trans('principal.btnca'), '', array('class'=>'btn btn-danger btn-close')) }}
				</div>
...
<script type="text/javascript">		
	...
	var id_estadoreg = '{{ $errores->id_estado }}'; 

	var estatus = '{{ $errores->estatus }}'; 

	var modobodega = '{{ $errores->modobodega }}';   
