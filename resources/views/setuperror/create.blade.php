...
@section('titulo')
	 {{ trans('principal.nerror') }}  
@endsection

@section('tituloPagina')
	<h3>{{ trans('principal.nerror') }} </h3>
@endsection
...
<div class="panel">
		<div class="panel-body">
			...
			@endif
				...
				{!! Form::open(['route'=>'setuperror.store','method'=>'POST','class'=>'form-horizontal bordered-row']) !!}
					
					
					<div class="form-group">
	                    {!! Form::label('modobodega',trans('principal.msgconferror'),['class'=>'col-sm-3 control-label']) !!}
	                    <div class="col-sm-6">
